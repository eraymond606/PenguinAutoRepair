...
export default function MobileEmployeeVerifyEmail() {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/mobile/employee/forgot/reset', { state: { email, code: verificationCode } });
  };

  return (
    <div className="mobile-frame employee-verify-screen">
