  ...
  return (
    <AuthLayout title="Vehicles" showDots={false}>
      <div className="vehicle-page-content">
        <div className="vehicle-page-hero">
          <h1 className="vehicle-title">Vehicles</h1>
        </div>
        <div className="vehicle-form-section">
          <h2 className="vehicle-form-heading">Add a <span className="vehicle-form-new">New Vehicle</span></h2>
          <form className="vehicle-form" onSubmit={handleSave}>
            ...
            <button type="submit" className="vehicle-form-submit">Submit</button>
          </form>
          ...
          {vehicles.length > 0 && (
            <div style={{ marginTop: 28, textAlign: 'center' }}>
              <button 
                type="button" 
                className="vehicle-schedule-btn" 
